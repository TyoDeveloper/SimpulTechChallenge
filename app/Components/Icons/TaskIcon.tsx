    ...
    <div className="relative flex items-center justify-center">
      ...
      <div
        ...
        className={`
          ...
          rounded-full ${TaskMode ? "bg-[#F8B76B]" : "bg-gray-200"}
          shadow-lg
        ...
        {TaskMode ? (
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M3.33334 3.88892H23.3333C24.5556 3.88892 25.5556 4.88892 25.5556 6.11114V20.5556C25.5556 21.7778 24.5556 22.7778 23.3333 22.7778H3.33334C2.11111 22.7778 1.11111 21.7778 1.11111 20.5556V6.11114C1.11111 4.88892 2.11111 3.88892 3.33334 3.88892ZM3.33334 6.11114V20.5556H12.2222V6.11114H3.33334ZM23.3333 20.5556H14.4444V6.11114H23.3333V20.5556ZM22.2222 10H15.5556V11.6667H22.2222V10ZM15.5556 12.7778H22.2222V14.4445H15.5556V12.7778ZM22.2222 15.5556H15.5556V17.2222H22.2222V15.5556Z"
              fill="white"
            />
          </svg>
        ) : (
